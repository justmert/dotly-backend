...
class SubscanActor:
    ...
    def __init__(self, session=None):
        ...
        self.subscan_rest_headers = {"Accept": "*/*", "x-api-key": os.environ["SUBSCAN_API_KEY"]}
    ...
    def subscan_rest_make_request(self, url, variables=None, data=None, max_page_fetch=float("inf")):
        ...
        while url and (current_fetch_count < max_page_fetch):
            ...
            elif response.status_code in [500, 502, 503, 504]:  # Internal server error
                logger.error(
    ...
    def rate_limit_wait(self, retry_after):
